...
| 名称      | サンプル                                                 | 説明                                                                                                                    |
| --------- | -------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| Ubroit    | <img alt="Normal" src="./images/Normal.png" width="266"> | 通常版。スタイルセット対応。<br> 内容については後述。                                                                   |
| Ubroit EH | <img alt="EH" src="./images/EH.png" width="266">         | 絵文字減らした版。スタイルセット対応。別の絵文字フォントとの併用推奨。<br>(サンプルの㊙は Apple Color Emoji のものです) |
| Ubroit BS | <img alt="BS" src="./images/BS.png" width="266">         | 基本版。<br> 全角スペースを可視化しています。                                                                           |
| Ubroit SP | <img alt="SP" src="./images/SP.png" width="266">         | スペシャルスペース版。<br> 半角スペース、ノーブレークスペースや em スペース等も可視化したバージョン。                   |
